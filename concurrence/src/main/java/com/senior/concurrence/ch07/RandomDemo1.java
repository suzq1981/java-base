...
public class RandomDemo1 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for(int i=0;i<100;i++){
            executor.submit(new RandomDemo1Runner(barrier,"thread"+i,random,cd));
        }
...
class RandomDemo1Runner implements Runnable {
    ...
    public RandomDemo1Runner(CyclicBarrier barrier, String name,Random random, CountDownLatch cd) {
        super();
